...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_AXIS1_MAX_TRAVEL 925.0 // mm
  #define DEFAULT_AXIS2_MAX_TRAVEL 668.0 // mm
  #define DEFAULT_AXIS3_MAX_TRAVEL 100.0 // mm
    ...
    #endif
  #endif
  #define DEFAULT_SPINDLE_RPM_MAX 12230 // rpm
  #define DEFAULT_SPINDLE_RPM_MIN 536 // rpm
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  #define DEFAULT_STEPPING_INVERT_MASK 0
  #define DEFAULT_DIRECTION_INVERT_MASK 0
  #define DEFAULT_STEPPER_IDLE_LOCK_TIME 255 // msec (0-254, 255 keeps steppers enabled)
  ...
  #define DEFAULT_REPORT_INCHES 0 // false
  #define DEFAULT_INVERT_ST_ENABLE 0 // false
  #define DEFAULT_INVERT_LIMIT_PINS 255 // all
